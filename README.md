...
<div align="center">
  ...
  |:--------|:------------|:-----|:------|
  | 🫀 [ami-early-diagnosis-xai](https://github.com/hacker007S/ami-early-diagnosis-xai) | Clinical ML predicting AMI from hematological biomarkers (RandomForest, XGBoost, LightGBM + SHAP) | Python, Scikit-Learn, XGBoost | [![Stars](https://img.shields.io/github/stars/hacker007S/ami-early-diagnosis-xai?style=flat-square&color=FFD700)](https://github.com/hacker007S/ami-early-diagnosis-xai) |
  | 📈 [stock-price-forecasting](https://github.com/hacker007S/stock-price-forecasting) | Multi-ticker stock forecasting with LSTM, GRU & XGBoost + SHAP explainability | Python, TensorFlow, XGBoost | [![Stars](https://img.shields.io/github/stars/hacker007S/stock-price-forecasting?style=flat-square&color=FFD700)](https://github.com/hacker007S/stock-price-forecasting) |
  | 👩‍⚕️ [contraceptive-method-prediction](https://github.com/hacker007S/contraceptive-method-prediction) | Public-health ML on UCI CMC dataset using SVM, Logistic Regression & RF with SMOTE | Python, Scikit-Learn | [![Stars](https://img.shields.io/github/stars/hacker007S/contraceptive-method-prediction?style=flat-square&color=FFD700)](https://github.com/hacker007S/contraceptive-method-prediction) |
  | 📞 [customer-churn-prediction](https://github.com/hacker007S/customer-churn-prediction) | End-to-end telecom churn ML: EDA, KMeans, SMOTE, XGBoost (99% AUC) + SHAP | Python, Scikit-Learn, XGBoost | [![Stars](https://img.shields.io/github/stars/hacker007S/customer-churn-prediction?style=flat-square&color=FFD700)](https://github.com/hacker007S/customer-churn-prediction) |
  | 👗 [closet-to-cash](https://github.com/hacker007S/closet-to-cash) | AI-powered resale scanner mobile app — Claude Vision AI + Supabase | React Native, Expo, TypeScript | [![Stars](https://img.shields.io/github/stars/hacker007S/closet-to-cash?style=flat-square&color=FFD700)](https://github.com/hacker007S/closet-to-cash) |
